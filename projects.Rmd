...
<figure style="text-align: center;">
    <img src="images/age1.png" style="width:30%; border:none;" alt="Diagnostic Tools Visualization" />
    <figcaption style="font-size: 14px; color: #555; margin-top: 5px;">
...
<figure style="text-align: center;">
    <img src="images/age2.png" style="width:30%; border:none;" alt="Diagnostic Tools Visualization" />
    <figcaption style="font-size: 14px; color: #555; margin-top: 5px;">
