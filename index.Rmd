...
I specialize in statistical analysis, variable modeling, and correlation analysis, with a passion for using data to explain health outcomes. Additionally, I have strong skills in research paper writing and the dissemination of findings through data visualization, aiming to improve health through evidence-based insights and clear communication. 
