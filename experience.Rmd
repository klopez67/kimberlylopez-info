...
<div class="timeline"> 
  <div class="timeline-item">
    <div class="timeline-content">
      ...
      At Boehringer Ingelheim, I collaborate with clinical data scientists to analyze large-scale clinical trial datasets using R and Python. I develop R programs which support statistical analyses and generate key result outputs such as tables, figures, and listings for ongoing trials. One of the most rewarding aspects of this role is designing interactive R Shiny dashboards that help translate complex data into accessible insights for broader teams. I am also gaining hands-on experience with industry standards like CDISC and learning the importance of reproducibility and clear documentation in clinical research. This experience continues to sharpen my programming skills and deepen my understanding of how data science supports evidence-based decision-making in healthcare and clinical research3. </p>
