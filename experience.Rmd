...
<div class="timeline"> 
  <div class="timeline-item">
    <div class="timeline-content">
      ...
      <p><strong>Year:</strong> 2025</p>
      <p><strong>Contributions:</strong>  While kidney disease is well-recognized in the T1D population, the cardiovascular complications tied to early kidney decline remain under-addressed. Motivated by this unmet need, I joined a phase II clinical trial project analyzing how a lipid-lowering drug might slow kidney function decline and ultimately improve cardiovascular outcomes in this high-risk population. I analyzed study data with the intention-to-treat approach following statistical plans outlined in study protocol. Additionally, we investigated differences in kidney biomarker given the research discussion of identifying the most accurate clinical research methods for assessing treatment effect on kidney function. 
 </p>
      <figure style="text-align: center;">
